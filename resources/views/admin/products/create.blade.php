...
<div class="bg-white rounded-lg shadow-sm border border-[#E8E1D5] p-6 max-w-2xl mx-auto">
    <div class="flex justify-between items-center mb-6 border-b border-gray-100 pb-4">
        <h3 class="text-xl font-bold text-[#2C3E50]">Tambah Produk Baru</h3>
    ...
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 gap-6">
            <!-- Info Dasar -->
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">ID Produk (Unik)</label>
                <input type="text" name="product_id" class="w-full p-2 border border-gray-300 rounded focus:ring-[#8B7355] focus:border-[#8B7355]" placeholder="contoh: PRD-001">
            </div>
            ...
            <div class="bg-gray-50 p-4 rounded border border-gray-200">
                ...
                <div id="weight-input" class="hidden">
                    ...
                    <input type="number" name="weight" value="1000" class="w-full p-2 border border-gray-300 rounded focus:ring-[#8B7355] focus:border-[#8B7355]" placeholder="contoh: 1000">
