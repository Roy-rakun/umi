...
<head>
    ...
    <title>Masuk - The Secret By Umi Fadillah</title>
    ...
    <div class="max-w-md w-full bg-white rounded-3xl shadow-xl overflow-hidden border border-pink-100">
        <div class="p-8">
            <div class="text-center mb-8">
                <h1 class="font-heading text-4xl font-bold text-[#7d2a2a] mb-2">Selamat Datang</h1>
                <p class="text-gray-400 text-sm">Silahkan Masuk ke Akun Anda</p>
            </div>
        ...
        <div class="bg-pink-50/30 px-8 py-5 border-t border-pink-100 text-center text-sm">
            <p class="text-gray-500">Belum Punya Akun? <a href="{{ route('register') }}" class="text-[#7d2a2a] font-bold hover:underline">Daftar</a></p>
        </div>
    </div>
</body>
</html>
