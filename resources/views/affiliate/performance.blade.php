...
<div class="bg-white rounded-xl shadow-sm border border-[#E8E1D5] p-6 mb-6">
    <h3 class="text-xl font-bold text-[#2C3E50] mb-4">Performance Overview</h3>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div class="p-4 bg-purple-50 rounded-lg border border-purple-100">
            <p class="text-sm text-purple-600 font-medium">EPC (Earnings Per Click)</p>
    ...
    <div class="border-2 border-dashed border-gray-200 rounded-lg h-64 flex items-center justify-center text-gray-400">
        Detailed Charts (Clicks vs Sales) will be here
    </div>
</div>
@endsection
